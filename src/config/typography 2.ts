...
export const typography = {
  ...
  // Letter Spacing
  letterSpacing: {
    tight: -0.32, // -0.02em converted to approximate pixels at 16px base
    normal: 0,
    wide: 0.16,   // 0.01em converted to approximate pixels at 16px base
    wider: 0.32,  // 0.02em converted to approximate pixels at 16px base
  },
